...
<head>
  ...
  <title>Controle Caixa - Registrar Entrada</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div w3-include-html="menu-lateral.php"></div>

    <script type="text/javascript" src="script-menu-lateral.js"></script>
    <script>
      includeHTML();
    </script>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Registrar Entrada</h1>

          <div>
            <form class="user">
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <label for="descricaoEntrada">Descrição da Entrada: </label>
                  <input type="text" class="form-control form-control-user" id="descricaoEntrada" placeholder="Descrição da Entrada">
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <input type="text" class="form-control form-control-user" id="valor_entrada" placeholder="Valor">
                </div>
              </div>
